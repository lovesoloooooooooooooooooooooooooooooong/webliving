...
var SeekSlider = /** @class */ (function (_super) {
    ...
    function SeekSlider(props) {
        ...
        _this.renderBufferProgress = function () {
            if (_this.props.bufferProgress) {
                if (_this.props.bufferColor) {
                    return React.createElement("div", { className: styles.buffered, style: __assign({}, _this.getPositionStyle(_this.props.bufferProgress), { backgroundColor: _this.props.bufferColor }) });
                }
                else {
                    return React.createElement("div", { className: styles.buffered, style: _this.getPositionStyle(_this.props.bufferProgress) });
                }
            }
            else {
                return null;
        ...
        _this.renderProgress = function () {
            if (_this.props.sliderColor) {
                return React.createElement("div", { className: styles.connect, style: __assign({}, _this.getPositionStyle(_this.props.currentTime), { backgroundColor: _this.props.sliderColor }) });
            }
            else {
                return React.createElement("div", { className: styles.connect, style: _this.getPositionStyle(_this.props.currentTime) });
            }
        };
        _this.renderHoverProgress = function () {
            if (_this.props.sliderHoverColor) {
                return React.createElement("div", { className: styles["seek-hover"], style: __assign({}, _this.getSeekHoverPosition(), { backgroundColor: _this.props.sliderHoverColor }) });
            }
            else {
                return React.createElement("div", { className: styles["seek-hover"], style: _this.getSeekHoverPosition() });
            }
        };
        _this.renderThumb = function () {
            if (_this.props.thumbColor) {
                return React.createElement("div", { className: _this.isThumbActive() ? styles.thumb + " " + styles.active : styles.thumb, style: __assign({}, _this.getThumbHandlerPosition()) },
                    React.createElement("div", { style: { backgroundColor: _this.props.thumbColor }, className: styles.handler }));
            }
            else {
                return React.createElement("div", { className: _this.isThumbActive() ? styles.thumb + " " + styles.active : styles.thumb, style: __assign({}, _this.getThumbHandlerPosition()) },
                    React.createElement("div", { className: styles.handler }));
            }
        };
    ...
    SeekSlider.prototype.drawHoverTime = function () {
        ...
        if (!this.props.hideHoverTime) {
            return (React.createElement("div", { className: this.isThumbActive() ? styles["hover-time"] + " " + styles.active : styles["hover-time"], style: this.getHoverTimePosition(), ref: function (ref) { return _this.hoverTime = ref; } }, this.getHoverTime()));
        }
        else {
            return null;
        }
    ...
    SeekSlider.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: styles["ui-video-seek-slider"] },
            React.createElement("div", { className: this.isThumbActive() ? styles.track + " " + styles.active : styles.track, ref: function (ref) { return _this.track = ref; }, onMouseMove: function (evt) { return _this.handleTrackHover(false, evt); }, onMouseLeave: function (evt) { return _this.handleTrackHover(true, evt); }, onMouseDown: function (evt) { return _this.setSeeking(true, evt); }, onTouchStart: function () { return _this.setMobileSeeking(true); } },
