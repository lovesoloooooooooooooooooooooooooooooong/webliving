...
export declare type AtomPlayerStatusPair = {
    readonly whiteboard: AtomPlayerStatus;
    readonly video: AtomPlayerStatus;
};
export declare type AtomPlayerStatusCompose = {
...
export declare type AtomPlayerStatusTransfer = {
    current: AtomPlayerStatus;
    previous: AtomPlayerStatus;
};
export declare type CombinePlayerStatusTransfer = {
    readonly previous: CombinePlayerStatus;
    readonly current: CombinePlayerStatus;
};
export declare type StatusChangeHandle = (status: PublicCombinedStatus, message?: string) => any;
