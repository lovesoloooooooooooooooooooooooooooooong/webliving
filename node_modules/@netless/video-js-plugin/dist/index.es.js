...
import { autorun, CNode, PlayerConsumer, RoomConsumer } from "white-web-sdk";
...
// src/components/SeekSlider.tsx
var SeekSlider = class extends Component {
  constructor(props) {
    super(props);
...
// src/components/PlayerController.tsx
var PlayerController = class extends Component2 {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    }, /* @__PURE__ */ React2.createElement(SeekSlider, {
      total: duration,
    ...
    }, this.operationButton()), /* @__PURE__ */ React2.createElement("div", {
    ...
    }, this.operationVolumeButton()), /* @__PURE__ */ React2.createElement("div", {
...
// src/components/VideoJsPlugin.tsx
var VideoJsPlugin = class extends Component3 {
  render() {
    const { cnode, size, scale } = this.props;
    return /* @__PURE__ */ React4.createElement(CNode, {
      context: cnode
    }, /* @__PURE__ */ React4.createElement(FlexTransform, {
      size,
      scale
    }, /* @__PURE__ */ React4.createElement(RoomConsumer, null, (room) => room && /* @__PURE__ */ React4.createElement(Impl, {
      room,
      ...this.props
    })), /* @__PURE__ */ React4.createElement(PlayerConsumer, null, (player) => player && /* @__PURE__ */ React4.createElement(Impl, {
      player,
      ...this.props
    }))));
  }
};
var Impl = class extends Component3 {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return /* @__PURE__ */ React4.createElement("div", {
    ...
    }, s.title && /* @__PURE__ */ React4.createElement("div", {
      className: "video-js-plugin-title"
    }, s.title), ((_c = s.close) != null ? _c : true) && /* @__PURE__ */ React4.createElement("div", {
      className: "videojs-plugin-close-icon",
      ref: this.setupClose
    }, "\xD7")), /* @__PURE__ */ React4.createElement(PlayerController, {
      duration,
      volume: s.volume,
      ...
      scale: this.props.scale,
      visible: true
    }), !((_d = this.props.plugin.context) == null ? void 0 : _d.hideMuteAlert) && this.state.NoSound && /* @__PURE__ */ React4.createElement("div", {
      ref: this.setupAlert,
      className: "videojs-plugin-muted-alert"
    }), this.state.MediaError && /* @__PURE__ */ React4.createElement("div", {
