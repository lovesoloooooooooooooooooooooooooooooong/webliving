...
export declare type Props = PluginProps<PluginContext, VideoJsPluginAttributes>;
export declare type Instance = PluginInstance<PluginContext, VideoJsPluginAttributes>;
...
export declare type Keys = keyof VideoJsPluginAttributes;
