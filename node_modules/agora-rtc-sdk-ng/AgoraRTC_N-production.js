...
function(){let a=V();return"Safari"===a.name&&14<=Number(a.version)}();k.info("browser compatibility",A(la),A(a))})();let nb={__CLIENT_LIST__:pc,__TRACK_LIST__:Bc,VERSION:ob,BUILD:"v4.7.3-0-g0eb931c7(11/16/2021, 7:57:58 PM)",setParameter:eb,getParameter:function(a){return v[a]},getSupportedCodec:async function(a){let b=null;a?(b=new En({}),b.addStream(a)):b=new Fn({});a=Oj(await b.createOfferSDP());return b.close(),a},checkSystemRequirements:function(){const a=u.reportApiInvoke(null,{name:D.CHECK_SYSTEM_REQUIREMENTS,
