...
export declare function toJS<T>(value: T): T;
...
export declare interface Views {
    readonly writableView: View | null;
...
export declare interface CustomInput {
    /**
     * 输入按下操作
     * @param x 按下的点在屏幕的 x 坐标（以屏幕左上角为原点）
     * @param y 按下的点在屏幕的 y 坐标（以屏幕左上角为原点）
     */
    inputDown(x: number, y: number): void;

    /**
     * 输入移动操作
     * @param x 移动的点在屏幕的 x 坐标（以屏幕左上角为原点）
     * @param y 移动的点在屏幕的 y 坐标（以屏幕左上角为原点）
     */
    inputMove(x: number, y: number): void;

    /**
     * 输入抬起操作
     * @param x 抬起的点在屏幕的 x 坐标（以屏幕左上角为原点）
     * @param y 抬起的点在屏幕的 y 坐标（以屏幕左上角为原点）
     */
