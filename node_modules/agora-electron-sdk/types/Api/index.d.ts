...
import { NodeRtcEngine, NodeRtcChannel, RtcStats, LocalVideoStats, LocalAudioStats, RemoteVideoStats, RemoteAudioStats, RemoteVideoTransportStats, RemoteAudioTransportStats, RemoteVideoState, RemoteVideoStateReason, RemoteAudioState, RemoteAudioStateReason, AgoraNetworkQuality, LastmileProbeResult, ClientRoleType, StreamType, ConnectionState, ConnectionChangeReason, MediaDeviceType, VIDEO_PROFILE_TYPE, TranscodingConfig, InjectStreamConfig, VoiceChangerPreset, AudioReverbPreset, LastmileProbeConfig, Priority, CameraCapturerConfiguration, ScreenSymbol, CaptureRect, CaptureParam, VideoContentHint, VideoEncoderConfiguration, UserInfo, RendererOptions, Metadata, RTMP_STREAMING_EVENT, AREA_CODE, STREAM_PUBLISH_STATE, STREAM_SUBSCRIBE_STATE, EncryptionConfig, AUDIO_EFFECT_PRESET, VOICE_BEAUTIFIER_PRESET, NETWORK_TYPE, ClientRoleOptions, CLOUD_PROXY_TYPE, LogConfig, VOICE_CONVERSION_PRESET, DataStreamConfig, LOCAL_AUDIO_STREAM_ERROR, LOCAL_AUDIO_STREAM_STATE, LOCAL_VIDEO_STREAM_STATE, LOCAL_VIDEO_STREAM_ERROR, AudioRecordingConfiguration, VirtualBackgroundSource, VIRTUAL_BACKGROUND_SOURCE_STATE_REASON, DisplayInfo, AUDIO_MIXING_DUAL_MONO_MODE, AudioFileInfo, AUDIO_FILE_INFO_ERROR } from './native_type';
...
declare class AgoraRtcEngine extends EventEmitter {
    ...
    destroyRenderView(key: 'local' | 'videosource' | number, channelId: string | undefined, view: Element, onFailure?: (err: Error) => void): void;
    /**
...
declare interface AgoraRtcEngine {
    ...
    on(evt: 'requestAudioFileInfo', cb: (info: AudioFileInfo, error: AUDIO_FILE_INFO_ERROR) => void): this;
    /**
     ...
     */
    on(evt: 'audioMixingStateChanged', cb: (state: number, reason: number) => void): this;
     ...
     */
    on(evt: 'localVideoStateChanged', cb: (localVideoState: LOCAL_VIDEO_STREAM_STATE, err: LOCAL_VIDEO_STREAM_ERROR) => void): this;
    /**
     ...
     */
    on(evt: 'localAudioStateChanged', cb: (state: LOCAL_AUDIO_STREAM_STATE, err: LOCAL_AUDIO_STREAM_ERROR) => void): this;
    /**
     ...
     */
    on(evt: 'audioPublishStateChanged', cb: (channel: string, oldState: STREAM_PUBLISH_STATE, newState: STREAM_PUBLISH_STATE, elapseSinceLastState: number) => void): this;
     ...
     * to the current state.
     */
    on(evt: 'videoPublishStateChanged', cb: (channel: string, oldState: STREAM_PUBLISH_STATE, newState: STREAM_PUBLISH_STATE, elapseSinceLastState: number) => void): this;
     ...
     * to the current state.
     */
    on(evt: 'audioSubscribeStateChanged', cb: (channel: string, uid: number, oldState: STREAM_SUBSCRIBE_STATE, newState: STREAM_SUBSCRIBE_STATE, elapseSinceLastState: number) => void): this;
     ...
     * to the current state.
     */
    on(evt: 'videoSubscribeStateChanged', cb: (channel: string, uid: number, oldState: STREAM_SUBSCRIBE_STATE, newState: STREAM_SUBSCRIBE_STATE, elapseSinceLastState: number) => void): this;
    /**
     * Reserved callback.
     */
    on(evt: 'uploadLogResult', cb: (requestId: string, success: boolean, reason: number) => void): this;
    /**
     ...
     */
    on(evt: 'virtualBackgroundSourceEnabled', cb: (enabled: boolean, reason: VIRTUAL_BACKGROUND_SOURCE_STATE_REASON) => void): this;
...
declare interface AgoraRtcChannel {
     ...
     * method until the SDK triggers this callback.
     */
    on(evt: 'rejoinChannelSuccess', cb: (uid: number, elapsed: number) => void): this;
     ...
     */
    on(evt: 'streamMessage', cb: (uid: number, streamId: number, data: string) => void): this;
    /** Occurs when the local user does not receive the data stream from the
     * remote user within five seconds.
     *
     * The SDK triggers this callback when the local user fails to receive the
     ...
     *
     */
    on(evt: 'streamInjectedStatus', cb: (url: string, uid: number, status: number) => void): this;
    /** Occurs when the remote media stream falls back to audio-only stream due
     * to poor network conditions or switches back to the video stream after the
     * network conditions improve.
     *
     ...
     * to the current state.
     */
    on(evt: 'audioPublishStateChanged', cb: (oldState: STREAM_PUBLISH_STATE, newState: STREAM_PUBLISH_STATE, elapseSinceLastState: number) => void): this;
    /** Occurs when the video publishing state changes.
     *
     * @since v3.2.0
     *
     ...
     * to the current state.
     */
    on(evt: 'videoPublishStateChanged', cb: (oldState: STREAM_PUBLISH_STATE, newState: STREAM_PUBLISH_STATE, elapseSinceLastState: number) => void): this;
    /** Occurs when the audio subscribing state changes.
     *
     * @since v3.2.0
     *
     ...
     * to the current state.
     */
    on(evt: 'audioSubscribeStateChanged', cb: (uid: number, oldState: STREAM_SUBSCRIBE_STATE, newState: STREAM_SUBSCRIBE_STATE, elapseSinceLastState: number) => void): this;
    /** Occurs when the video subscribing state changes.
     *
     * @since v3.2.0
     *
     ...
     * to the current state.
     */
    on(evt: 'videoSubscribeStateChanged', cb: (uid: number, oldState: STREAM_SUBSCRIBE_STATE, newState: STREAM_SUBSCRIBE_STATE, elapseSinceLastState: number) => void): this;
    on(evt: 'agoraVideoRowData', cb: (info: {
        type: number;
        uid: number;
        channelId: string;
        header: any;
