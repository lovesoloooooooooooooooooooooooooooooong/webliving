import { AbstractErrorCenter } from 'agora-rte-sdk';
export declare class EduErrorCenter extends AbstractErrorCenter {
    static shared: EduErrorCenter;
...
export declare enum AGEduErrorCode {
...
export declare const getEduErrorMessage: (error: Error) => any;
