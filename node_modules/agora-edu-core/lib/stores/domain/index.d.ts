...
export { CloudDriveResource, CloudDriveCourseResource, CloudDriveMediaResource, CloudDriveImageResource, CloudDriveUploadingProgress, } from './common/cloud-drive/struct';
...
export type { AgoraExtAppContext, IAgoraExtApp, AgoraExtAppHandle, AgoraExtAppUserInfo, AgoraExtAppRoomInfo, AgoraExtAppEventHandler, } from './common/ext-app/type';
